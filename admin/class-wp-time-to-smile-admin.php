 ...
 * @subpackage Wp_Time_To_Smile/admin
 * @author     Raul Filea <raulfilea@gmail.com>
 */
class Wp_Time_To_Smile_Admin {
	...
	public function wpmr_admin_tabs() {
		...
		if( $cs == 'time-to-smile_page_wpmr-reports' ) {
			$tab = $_GET['tab'];
			?>
			<h1 class="nav-tab-wrapper">
				<a href="admin.php?page=wpmr-reports&tab=patients" class="nav-tab <?php if( $cs == 'time-to-smile_page_wpmr-reports' && $tab == 'patients' ) echo 'nav-tab-active'; else echo ''; ?> nav-tab-1">Patients</a>
				<a href="admin.php?page=wpmr-reports&tab=doctors" class="nav-tab <?php if( $cs == 'time-to-smile_page_wpmr-reports' && $tab == 'doctors' ) echo 'nav-tab-active'; else echo ''; ?> nav-tab-1">Doctors</a>
				<a href="admin.php?page=wpmr-reports&tab=episodes" class="nav-tab <?php if( $cs == 'time-to-smile_page_wpmr-reports' && $tab == 'episodes' ) echo 'nav-tab-active'; else echo ''; ?> nav-tab-1">Episodes</a>
				<a href="admin.php?page=wpmr-reports&tab=visits" class="nav-tab <?php if( $cs == 'time-to-smile_page_wpmr-reports' && $tab == 'visits' ) echo 'nav-tab-active'; else echo ''; ?> nav-tab-1">Visits</a>
				<a href="admin.php?page=wpmr-reports&tab=admissions" class="nav-tab <?php if( $cs == 'time-to-smile_page_wpmr-reports' && $tab == 'admissions' ) echo 'nav-tab-active'; else echo ''; ?> nav-tab-1">Admissions</a>
			</h1>
			<?php
		}
	}
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wp-time-to-smile-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wp-time-to-smile-admin.js', array( 'jquery' ), $this->version, false );
